...
module.exports = function(browser, script_for_sauce_data_schemas, timeout, callback) {
  async.waterfall([
    function(callback) {
      waitUntilResultsAreAvailable(browser, script_for_sauce_data_schemas, timeout, null, callback);
    },
    ...
    function(obj, callback) {
      ...
      api(browser.sessionID, data).then(function(body) {
        obj.body = body;
        callback(null, obj);
      }, function(err) {
        callback(err, obj);
