...
if (argv.help) {
  optimist.showHelp();
  process.exit(0);
} else if (!auth.username || !auth.accessKey) {
  console.error("Please, provide the username and the access key for SauceLabs. Use the option --help for more information.");
  process.exit(0);
}
