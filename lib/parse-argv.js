...
module.exports = function(argv) {
  var result = new commander.Command()
    ...
    .option('-t, --tunnel-identifier <name>', 'Define a tunnel name [$GITHUB_RUN_ID, else saucie]', defaults.tunnelIdentifier)
    .option('--build <name>', 'Define the build name/number [$GITHUB_RUN_NUMBER]', defaults.build)
    ...
    .option('--region <region>', `Sauce Labs datacenter region, e.g.: 'us-west', 'eu-central' [${defaults.region}]`, defaults.region)
    .parse(argv);
