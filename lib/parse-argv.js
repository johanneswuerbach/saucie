...
module.exports = function(argv) {
  var result = new commander.Command()
    ...
    .option('-t, --tunnel-identifier <name>', 'Define a tunnel name [$TRAVIS_JOB_NUMBER or $GITHUB_RUN_ID]', defaults.tunnelIdentifier)
    .option('--build <name>', 'Define the build name/number [$TRAVIS_BUILD_NUMBER or $GITHUB_RUN_NUMBER]', defaults.build)
